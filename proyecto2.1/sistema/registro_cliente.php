...
<div class="content">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="lista_cliente.php" class="btn btn-secondary">Regresar</a>
    </div>
        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="number" placeholder="Ingrese identidad" name="dni" id="dni" class="form-control">
                </div>
                <div class="form-group">
                ...
                <input type="submit" value="Guardar Cliente" class="btn btn-secondary">
            </form>
        </div>
    </div>
