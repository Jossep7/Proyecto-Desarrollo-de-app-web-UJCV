        ...
        <div class="col-lg-6 m-auto">
            ...
            <div class="card">
                <form action="" autocomplete="off" method="post" class="card-body p-2">
                    ...
                    <div class="form-group">
                        <label for="contacto">RTN</label>
                        <input type="text" placeholder="Ingrese El RTN" name="contacto" id="contacto" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <input type="submit" value="Guardar Proveedor" class="btn btn-secondary">
