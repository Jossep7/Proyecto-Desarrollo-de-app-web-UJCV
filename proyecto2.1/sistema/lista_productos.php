...
<div class="content">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="registro_producto.php" class="btn btn-secondary">Nuevo</a>
		<?php } ?>
	</div>
...
<center>
		<a href="ProductosExcel.php" class="btn btn-secondary">Exportar a Excel</a>

		<a href="reporte_producto.php" class="btn btn-secondary" target="_blank">Exportar PDF</a>
			</center>
			</div>
		</div>
</div>
