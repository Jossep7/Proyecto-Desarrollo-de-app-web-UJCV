...
<div class="content">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="registro_usuario.php" class="btn btn-secondary">Nuevo</a>
		<?php } ?>
	</div>
...
<center>
		<a href="UsuariosExcel.php" class="btn btn-secondary">Exportar a Excel</a>

		<a href="reporte_usuarios.php" class="btn btn-secondary" target="_blank">Exportar PDF</a>
			</center>
		</div>
	</div>
